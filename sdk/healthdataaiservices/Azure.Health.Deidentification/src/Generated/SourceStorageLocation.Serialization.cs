...
{
    public partial class SourceStorageLocation : IUtf8JsonSerializable, IJsonModel<SourceStorageLocation>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SourceStorageLocation>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        internal static SourceStorageLocation DeserializeSourceStorageLocation(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        SourceStorageLocation IPersistableModel<SourceStorageLocation>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<SourceStorageLocation>)this).GetFormatFromOptions(options) : options.Format;
        ...
        internal static SourceStorageLocation FromResponse(Response response)
        {
            using var document = JsonDocument.Parse(response.Content);
            return DeserializeSourceStorageLocation(document.RootElement);
        }
