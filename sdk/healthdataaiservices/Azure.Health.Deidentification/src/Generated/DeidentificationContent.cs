...
namespace Azure.Health.Deidentification
{
    ...
    public partial class DeidentificationContent
    {
        ...
        internal DeidentificationContent(string inputText, DocumentDataType? dataType, CustomizationConfig customizations, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            InputText = inputText;
            DataType = dataType;
