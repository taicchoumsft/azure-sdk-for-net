...
namespace Azure.AI.Speech.Transcription
{
    ...
    public partial class Transcription
    {
        ...
        /// <summary> Initializes a new instance of <see cref="Transcription"/>. </summary>
        ...
        public Transcription(TranscriptionProperties properties, string locale, string displayName)
        {
        ...
        internal Transcription(TranscriptionLinks links, TranscriptionProperties properties, Uri self, EntityReference model, EntityReference dataset, IList<Uri> contentUrls, Uri contentContainerUrl, string locale, string displayName, string description, IDictionary<string, string> customProperties, EntityReference project, DateTimeOffset? lastActionDateTime, Status? status, DateTimeOffset? createdDateTime, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Links = links;
            Properties = properties;
            Self = self;
        ...
        /// <summary> Initializes a new instance of <see cref="Transcription"/> for deserialization. </summary>
