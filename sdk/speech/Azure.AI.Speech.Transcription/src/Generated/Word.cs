...
namespace Azure.AI.Speech.Transcription
{
    ...
    public partial class Word
    {
        ...
        /// <summary> Initializes a new instance of <see cref="Word"/>. </summary>
        ...
        internal Word(string text, int offsetMilliseconds, int durationMilliseconds)
        {
        ...
        internal Word(string text, int offsetMilliseconds, int durationMilliseconds, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Text = text;
            OffsetMilliseconds = offsetMilliseconds;
            DurationMilliseconds = durationMilliseconds;
        ...
        /// <summary> Initializes a new instance of <see cref="Word"/> for deserialization. </summary>
        internal Word()
        {
        }
